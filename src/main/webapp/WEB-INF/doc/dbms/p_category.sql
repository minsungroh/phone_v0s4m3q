...
3. 목록
1) 전체 목록
SELECT phonecategoryno, title, orderno, visible, ids,cnt,codeno
FROM p_category
ORDER BY phonecategoryno ASC;


4. 수정
UPDATE p_category
SET codeno='', title='AAA', orderno='1', visible='Y', ids='admin', cnt='1' 
WHERE phonecategoryno=1;
