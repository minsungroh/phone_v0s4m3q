...
values ('user1', '1234', '왕눈이', 'F', '010-1234-5678', '12345', '서울시 관철동', '관철동', now());

insert into member(id, passwd, mname, grade, tel, zipcode, address1, address2, mdate)
values ('user2', '1234', '철수', 'F', '010-1234-5678', '12345', '서울시 관철동', '관철동', now());

insert into member(id, passwd, mname, grade, tel, zipcode, address1, address2, mdate)
values ('user3', '1234', '영희', 'F', '010-1234-5678', '12345', '서울시 관철동', '관철동', now());
